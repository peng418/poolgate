...
> **立项日期**：2026-09-24 ｜ **状态**：需求 / 设计方案已确认；实现到 **0.4.8**（安装包见 [Releases](https://github.com/peng418/poolgate/releases)）
...
**当前版本 0.4.8**（2026-09-25）：**Gemini 渠道** —— 走 Google **官方 OAuth**（user-code 流 + PKCE，粘贴授权码即完成），
