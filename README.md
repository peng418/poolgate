...
> **立项日期**：2026-09-24 ｜ **状态**：需求 / 设计方案已确认；实现到 **0.4.5**（安装包见 [Releases](https://github.com/peng418/poolgate/releases)）
...
**当前版本 0.4.5**（2026-09-25）：**防封号基础设施** —— 一账号一出口代理（`Credential.Extra["proxy"]`）
