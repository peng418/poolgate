...
> **立项日期**：2026-09-24 ｜ **状态**：需求 / 设计方案已确认；实现到 **0.4.6**（安装包见 [Releases](https://github.com/peng418/poolgate/releases)）
...
**当前版本 0.4.6**（2026-09-25）：**通义（Qwen）渠道** —— 第一个「扫码登录式」新渠道：设备码授权（不要邮箱密码）
