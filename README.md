...
> **立项日期**：2026-09-24 ｜ **状态**：需求 / 设计方案已确认；已发布 **0.4.8**，工作区到 **0.5.0（未发布）**（安装包见 [Releases](https://github.com/peng418/poolgate/releases)）
...
**当前版本 0.5.0（未发布）**：**「全部走登录式」** —— 按裁定不再做 API Key 式接入，
...
0.4.9（未发布）：**DeepSeek（网页版）渠道** —— 粘贴 userToken 式登录（面板引导，不存密码），
